  ...
  return [
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex flex-col">
            <div className="font-medium">{recruitment.full_name}</div>
          ...
          <div className="flex flex-col">
            ...
            {recruitment.job_position && (
              <div className="text-sm text-muted-foreground">
                {recruitment.job_position.department} - {recruitment.job_position.location}
              </div>
            )}
          </div>
        );
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const salaryExpectation = row.original.salary_expectation;
